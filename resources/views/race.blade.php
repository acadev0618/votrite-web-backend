								...
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-5 form-group">
											...
											<div class="col-sm-10">
												<select class="form-control select_ballot" name="ballot_name" id="ballot_name">
    ...
    <div class="modal-body">
        ...
        @csrf
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <select class="form-control" name="ballot_id" id="add_ballot_name">
                    @foreach($ballots as $ballot)
                        <option value="{{ $ballot->ballot_id }}">{{ $ballot->election }}</opiton>
                    @endforeach
				    </select>
        ...
        <form class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    ...
                    <!-- <input type="text" class="form-control" id="race_type" name="race_type" readonly> -->
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-5" for="title">Mimimum number of votes:</label>
