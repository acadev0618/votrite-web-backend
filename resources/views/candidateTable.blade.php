	...
	<thead>
		<tr>
			<th class="table-checkbox">
				<input type="checkbox" class="group-checkable" data-set="#candidate_table .checkboxes" style="width: 17px; height: 17px;"/>
			</th>
			<th class="table-no">
				No
			</th>
	...
	@else
		...
		@else
			...
			@else
				...
				<tr class="odd gradeX">
					<td>
						<input type="checkbox" class="checkboxes" value="1" data-id="{{ $candidate->candidate_id }}" style="width: 17px; height: 17px;"/>
					</td>
					<td>
						{{ $loop->index+1 }}
					</td>
